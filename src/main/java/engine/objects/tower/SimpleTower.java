 ...
 * It is used to wrap around ("decorate") with tower behaviors such as shooting, money-farming
 * ability, etc.
...
public class SimpleTower extends TDObject implements ITower {
    ...
    public static final String TOWER_TYPE = "Simple Tower";
