...
public class TowerViewConstants {
	...
	public static final int BUILDUP_DEFAULT = 100;
	public static final int RANGE_DEFAULT = 200;
	 ...
	 */
	public static final int FREEZE_SLOWDOWN_DEFAULT = 95;
	public static final Serializable FIRING_SPEED_DEFAULT = 1;
