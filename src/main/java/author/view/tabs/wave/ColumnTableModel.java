...
abstract class ColumnTableModel<T> extends AbstractTableModel {
	...
	protected ColumnTableModel(Class columnClass) {
		setColumnClass(columnClass );
	}

	
	protected ColumnTableModel(List<String> columnNames) {
		this(new ArrayList<T>(), columnNames);
	}

	
	protected ColumnTableModel(List<T> modelData, List<String> columnNames) {
		setDataAndColumnNames(modelData, columnNames);
	}

	
	protected ColumnTableModel(List<T> modelData, List<String> columnNames, Class rowClass) {
		setDataAndColumnNames(modelData, columnNames);
